...
export const books = [{
  ...
  desc: "The author posits that there is indeed a secret to an amazing life, but it's a secret that everyone can find! According to the author's theory, you should envision your life as a car. When you think about your life that way, you can remember that thecar of your life should be equally balanced on four tires."
}, {
  id: ++num,
